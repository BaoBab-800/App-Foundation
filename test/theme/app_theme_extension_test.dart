...
const _first = AppThemeExtension(
  ...
  status: ResolvedStatusColors(
    error: Color(0xFF112233), onError: Color(0xFF223344),
    warning: Color(0xFF334455), onWarning: Color(0xFF445566),
    success: Color(0xFF556677), onSuccess: Color(0xFF667788),
    info: Color(0xFF778899), onInfo: Color(0xFF8899AA),
  ),
  outlines: ResolvedOutlinesColors(
    outline: Color(0xFF99AABB), outlineVariant: Color(0xFFAABBCC),
  ),
);
...
const _second = AppThemeExtension(
  ...
  status: ResolvedStatusColors(
    error: Color(0xFF213243), onError: Color(0xFF324354),
    warning: Color(0xFF435465), onWarning: Color(0xFF546576),
    success: Color(0xFF657687), onSuccess: Color(0xFF768798),
    info: Color(0xFF8798A9), onInfo: Color(0xFF98A9BA),
  ),
  outlines: ResolvedOutlinesColors(
    outline: Color(0xFFA9BACB), outlineVariant: Color(0xFFBACBDC),
  ),
);
...
AppThemeExtension _lerpExtension(
  ...
  content: ResolvedContentColors(
    text: Color.lerp(first.content.text, second.content.text, t)!,
  ...
  status: ResolvedStatusColors(
    error: Color.lerp(first.status.error, second.status.error, t)!,
    onError: Color.lerp(first.status.onError, second.status.onError, t)!,
    warning: Color.lerp(first.status.warning, second.status.warning, t)!,
    onWarning: Color.lerp(first.status.onWarning, second.status.onWarning, t)!,
    success: Color.lerp(first.status.success, second.status.success, t)!,
    onSuccess: Color.lerp(first.status.onSuccess, second.status.onSuccess, t)!,
    info: Color.lerp(first.status.info, second.status.info, t)!,
    onInfo: Color.lerp(first.status.onInfo, second.status.onInfo, t)!,
  ),
  outlines: ResolvedOutlinesColors(
